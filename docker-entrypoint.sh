...
if [ ! -f Gemfile ]; then
	...
	echo ""
	echo "docker run -p 4000:4000 -v \$(pwd):/site labhackers/jekyll-serve"
	echo ""
	echo "NOTE: To create a new site, you can use the sister image labhackers/jekyll like:"
	echo ""
	echo "docker run -v \$(pwd):/site labhackers/jekyll new ."
	exit 1
fi
